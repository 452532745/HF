    ...
    <div id="banner">
      <div class="wrap">
        <transition-group tag="ul" class="banner-box" name="list">
          <li class="banner-list" v-for="(item,index) in imgList" :key="item" v-show="index === mark" @mouseenter="stop" @mouseleave="go">
        ...
        <ul class="banner-hd">
          <li v-for="(item,index) in imgList" :key="item" :class="{ 'on': index == mark }" @mouseover="change(index)" @mouseenter="stop" @mouseleave="go"></li>
        </ul>
      </div>
